...
class Answer(BaseModel):
    ...
    Footprint_size: str = Field(description="Area size of activity")
    ...
    Offsetting: str = Field(description="The activity described in the given data")
...
def testing_visual_models(image_b64):
    ...
    for vision_model in vision_model_list:
        ...
        chain = prompt_func | llm | output_parser
        while attempt < 3:
